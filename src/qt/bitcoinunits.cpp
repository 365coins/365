...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("365");
    case mBTC: return QString("m365");
    case uBTC: return QString::fromUtf8("μ365");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("365Coins"));
    case mBTC: return QString(QObject::tr("Milli-The365Coins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-The365Coins (1 / 1,000,000)"));
    default: return QString("???");
    }
}

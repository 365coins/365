...
const string strMessageMagic = "The365Coin Signed Message:\n";
...
{
    int64_t nRewardCoinYear = 50 * CENT;
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("The365Coin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in The365Coin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // The365Coin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "The365Coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "365 genesis";
        CTransaction txNew;
        txNew.nTime = 1460105017;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1460105017;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1714092; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xb7, 0xf5, 0xe4, 0xe5 };

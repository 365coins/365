...
void ThreadIRCSeed(void* parg)
{
    ...
    RenameThread("The365Coin-ircseed");
...
void ThreadIRCSeed2(void* parg)
{
    ...
    while (!fShutdown)
    {
        ...
        if (fTestNet) {
            Send(hSocket, "JOIN #The365CoinTEST2\r");
            Send(hSocket, "WHO #The365CoinTEST2\r");
        } else {
            // randomly join #The365Coin00-#The365Coin05
            // int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #The365Coin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #The365Coin%02d\r", channel_number).c_str());
        }

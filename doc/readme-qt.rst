The365Coin-qt: Qt4 GUI for The365Coin
===============================
...
Alternatively, install Qt Creator and open the `The365Coin-qt.pro` file.

An executable named `The365Coin-qt` will be built.
...
A warning for people using the *static binary* version of The365Coin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of The365Coin is linked against libdb5.3.
...
installed causes The365Coin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
